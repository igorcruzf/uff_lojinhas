...
class ItemsFormNew extends StatefulWidget with ItemsFieldsValidators {
  @override
  _ItemsFormNewState createState() => _ItemsFormNewState();
}

class _ItemsFormNewState extends State<ItemsFormNew> {
