...
class ItemsRegisterPage extends StatefulWidget with ItemsFieldsValidators {
  @override
  _ItemsRegisterPageState createState() => _ItemsRegisterPageState();
}

class _ItemsRegisterPageState extends State<ItemsRegisterPage> {
  ...
  void _submitMore() async {
    ...
    Navigator.of(context).push(
      MaterialPageRoute<void>(
        ...
        builder: (context) => ItemsRegisterPage(),
      ),
    );
  }
